...
const Header = () => {
    ...
    return (
        <header className='fixed flex justify-between top-5 left-5 right-5'>
            <div className='w-1/3 h-20 bg-foreground/70 dark:bg-foreground/90 text-background p-6 pr-9 cp-full-bevel-br flex items-center justify-start'>
            ...
            <div className='w-1/3 h-20 bg-foreground/70 dark:bg-foreground/90 text-background p-6 pl-9 cp-full-bevel-bl flex items-center justify-end gap-4'>
