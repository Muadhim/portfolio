...
const AboutSection = () => {
    return (
        <section className='max-w-[1000px] w-fit min-h-[600px] h-fit bg-foreground/90 backdrop-blur-sm dark:bg-foreground/90 absolute top-1/2 -translate-y-1/2 cp-bevel p-4 text-background'>
            <h3 className='font-bold text-3xl text-center'>ABOUT</h3>
            <div className='mt-4'>
